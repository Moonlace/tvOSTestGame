...
- (void)registerCharacterMovementEvents:(GCController *)gameController {
    ...
    microGamepad.buttonX.valueChangedHandler = buttonHandler;
    microGamepad.valueChangedHandler = ^(GCMicroGamepad *gamepad, GCControllerElement *element) {
        //NSLog(@"That update gamepad %@", gamepad);
        //NSLog(@"That element %@", element);
    };
